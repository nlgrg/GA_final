...
def cal_fitness(q1, q2):
    ...
    return max(roll_diff_arcsec, pitch_diff_arcsec, yaw_diff_arcsec)**10
...
def fitness_func(solution):
    ...
    with open("constants.h", "w") as file:
        ...
        for i, param_range in enumerate(gene_bounds):
            ...
            file.write("#define LENGTH 1821\n")
            file.write("#define BREADTH 1821\n")     
            ...
            file.write("#define Y_MIN 0.983276956198341\n")
